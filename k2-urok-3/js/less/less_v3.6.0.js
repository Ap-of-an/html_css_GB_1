...
! function (a) {
  ...
  return function a(b, c, d) {
    ...
    12: [function (a, b, c) {
      ...
      }, d.Eval.prototype.inCalc = !1, d.Eval.prototype.mathOn = !0, d.Eval.prototype.isMathOn = function () {
    ...
    62: [function (a, b, c) {
      ...
      g.prototype = new d, g.prototype.type = "Expression", g.prototype.accept = function (a) {
        ...
        var b, c = a.isMathOn(),
          ...
          f = !1;
        return d && a.inParenthesis(), this.value.length > 1 ? b = new g(this.value.map(function (b) {
          return b.eval ? b.eval(a) : b
        }), this.noSpacing) : 1 === this.value.length ? (!this.value[0].parens || this.value[0].parensInOp || a.inCalc || (f = !0), b = this.value[0].eval(a)) : b = this, d && a.outOfParenthesis(), this.parens && this.parensInOp && !c && !f && (b = new e(b)), b
      }, g.prototype.genCSS = function (a, b) {
    ...
    71: [function (a, b, c) {
      var d = a("./selector"),
        ...
        l = function (a, b, c, f, g, h, i) {
          this.name = a, this.selectors = [new d([new e(null, a, (!1), this._index, this._fileInfo)])], this.params = b, this.condition = f, this.variadic = g, this.arity = b.length, this.rules = c, this._lookups = {};
          var j = [];
      ...
      var d = {
        ...
        flattenArray: function (a, b) {
          ...
          for (var c = 0, e = a.length; c < e; c++) {
            var f = a[c];
            Array.isArray(f) ? d.flattenArray(f, b) : void 0 !== f && b.push(f)
          }
          return b
        }
      };
